...
public class MainFrame extends Frame {
  ...
  private void jbInit() throws Exception {
    ...
    menuItem8.setLabel("Save/BSP/DOOM");
        ...
        if(mf.lastwp!=null) {
          if(e.isPopupTrigger()) {
            mf.lastwp.wr.zoom(e.getX(),e.getY(),2.0f);
             ...
             mf.lastwp.wr.addstep(e.getX(),e.getY(),false);
          } else if((e.getModifiers()&MouseEvent.ALT_MASK)!=0) {
             mf.lastwp.wr.addstep(e.getX(),e.getY(),true);
          } else if(dragged) {
