...
class WadRun {
  ...
  void addbuiltins() {
    ...
    /*
    builtin("mirror", 0, new Builtin() { Exp eval() {
      mirror = !mirror;
      return n;
    }});
    */
  ...
  void addstep(int clickx, int clicky, boolean curve) {
  ...
  void render(Graphics g) {
    ...
    if(renderthings) for(int i = 0;i<things.size();i++) {
      ...
      int x = (int)((t.x-xmid)/scale)+gxmid;
      int y = (int)((t.y-ymid)/scale)+gymid;
  ...
  Exp call(Id caller) {
    ...
    if(f!=null) {
      ...
      if(b!=null) {
        ...
        switch(nargs) {
          case 0: return b.eval();
          case 1: return b.eval(((Exp)v.elementAt(0)).eval(this));
          case 2: return b.eval(((Exp)v.elementAt(0)).eval(this),
                                ((Exp)v.elementAt(1)).eval(this));
          case 3: return b.eval(((Exp)v.elementAt(0)).eval(this),
                                ((Exp)v.elementAt(1)).eval(this),
                                ((Exp)v.elementAt(2)).eval(this));
          case 4: return b.eval(((Exp)v.elementAt(0)).eval(this),
                                ((Exp)v.elementAt(1)).eval(this),
                                ((Exp)v.elementAt(2)).eval(this),
                                ((Exp)v.elementAt(3)).eval(this));
          case 5: return b.eval(((Exp)v.elementAt(0)).eval(this),
                                ((Exp)v.elementAt(1)).eval(this),
                                ((Exp)v.elementAt(2)).eval(this),
                                ((Exp)v.elementAt(3)).eval(this),
                                ((Exp)v.elementAt(4)).eval(this));
          case 6: return b.eval(((Exp)v.elementAt(0)).eval(this),
                                ((Exp)v.elementAt(1)).eval(this),
                                ((Exp)v.elementAt(2)).eval(this),
                                ((Exp)v.elementAt(3)).eval(this),
                                ((Exp)v.elementAt(4)).eval(this),
    ...
    wp.error("undefined identifier: "+caller.s);
    return null;
  }
  ...
  void marchingcubes(int scale, int __height, int __density) {
    int gridx = scale;
    int gridy = scale;
    int numlevels = 3;
    int gridsize = 64;
    ...
    for(int x = 0; x<gridx; x++) for(int y = 0; y<gridy; y++) {
      grid[x][y] = (x==0 || y==0 || x==gridx-1 || y==gridy-1) ? 0 : rnd(numlevels)+1;
    };
