 ...
 * (but see below for the original public domain declaration.
 *  presently this file is unmodified from the PD release
 *  asides from this comment and the package declaration)
 *
