...
main {
  ...
  twice( slimecurve(0,128,0) )

  -- fade into colour
  set("itr",0)
  for(1,15,
    slimecorridor(16,0,128,mul(get("itr"),8))
  ...
  slimecurve_r(0,128,120)
  move(32)

  pushpop( move(640) slimechoke(0,120) )
  slimecorridor(64,0,128,120)
  slimeopening(512,0,128,120)
  slimecorridor(64,0,128,120)
  !entrancecorridor
  ...
  slimecurve(0,128,120)
  slimecorridor(256,0,128,120)
  slimesecret(256,0,120, doublebarreled thing)
  slimecorridor(128,0,128,120)

  pushpop(movestep(384,384) rotright slimechoke(0,120) )
  slimesplit(0,120,

    -- left branch
    slimecorridor(1024,0,128,120) 
   ,
...
--    slimechoke(0,120)
    ...
    set("itr",0)
    for(1,15,
      slimecorridor(16,0,128,sub(mul(8,15),mul(get("itr"),8)))
      set("itr",add(1,get("itr")))  
    )
    slimecurve_r(0,128,0)
    slimecurve_r(0,128,0)
  )
}
